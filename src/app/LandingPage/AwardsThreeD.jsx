...
const img1 = "/assets/awards/Aims.webp";
const img2 = "/assets/awards/Best B-School.webp";
const img3 = "/assets/awards/Best Business School.webp";
const img4 = "/assets/awards/Economic Times.webp";
const img5 = "/assets/awards/Centre of Academic.webp";
  ...
  return (
    ...
    >
      <div className="relative z-30 px-4 mx-auto max-w-screen-xl md:px-8">
        ...
        >
          <Link href="/about/accreditations-awards">
            <ShimmerButton
