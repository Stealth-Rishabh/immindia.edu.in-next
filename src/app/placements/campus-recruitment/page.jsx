...
const img = "/assets/faculty/Banner.webp";
...
const CampusRecruitment = () => {
  ...
  return (
    <div className="relative min-h-screen ">
      <ImgAndBreadcrumb
        title=""
        imageSrc={isMobile ? "/banners/campusM.webp" : "/banners/campus.webp"}
      ...
      <Container className="container grid ">
        ...
        />
        <CompanyLogos isMobile={isMobile} />
      </Container>
...
function CompanyLogos({ isMobile }) {
  ...
  const getVisibleLogos = (companies) => {
    return showAll ? companies : companies.slice(0, isMobile ? 24 : 65);
  };
