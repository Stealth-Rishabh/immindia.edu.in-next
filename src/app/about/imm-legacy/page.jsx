...
const founder = "/assets/about/leadership/founder1.webp";
const building = "/assets/Building.webp";
      ...
      <div className="container ">
        <div className="grid lg:grid-cols-3 gap-x-6">
          ...
          <div className="lg:px-4 my-6 lg:my-0">
            <div className="min-h-[400px] md:h-full rounded-md overflow-hidden">
              <Image
                src={founder}
                alt="IMM Founder"
                width={400}
          ...
          >
            <div className="relative h-full z-10">
              ...
              <Image
                ...
                width={600}
                height={600}
                className="bg-center bg-no-repeat bg-cover rounded-2xl min-h-[350px] w-full float-right shadow-xl h-[400px] sm:h-[600px] object-cover"
              />
            </div>
          </div>
