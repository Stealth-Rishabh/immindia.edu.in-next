    ...
    >
      <div className="flex size-full flex-col max-w-lg max-h-[550px] sm:-mt-10 sm:py-10 items-stretch justify-between gap-20">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Image
            src="/assets/pgdm/aicet.png"
            alt="aicte"
            width={80}
            height={80}
            className="w-20 h-20 drop-shadow-lg  hover:scale-110 transition-all duration-300 hover:drop-shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]"
          />
...
// Icons object with string constants and Image components
const Icons = {
  dataScience: () => (
    <Image
      src="/assets/bba/icons/digital.gif"
      alt="DS"
      width={80}
      height={80}
  ...
  python: () => (
    <Image
      src="/assets/bba/icons/nudge.gif"
      alt="python"
      width={80}
      height={80}
      className="absolute top-0 left-0 w-full h-full p-3"
  ...
  machineLearning: () => (
    <Image
      src="/assets/bba/icons/research.gif"
      alt="ML"
      width={80}
      height={80}
      className="absolute top-0 left-0 w-full h-full p-3"
  ...
  metaverse: () => (
    <Image
      src="/assets/bba/icons/projects.gif"
      alt="MV"
      width={80}
      height={80}
      className="absolute top-0 left-0 w-full h-full p-3"
