    ...
    <section className=" ">
      <div className="space-y-4">
        ...
        <p className="text-gray-600 text-base backdrop-blur-sm">
          IMM is one of the most premium Business Schools for PGDM in Delhi. The
          two-year full-time Post Graduate Diploma in Management (PGDM), is the
          flagship programme of IMM-Business School.
        </p>
        {isOpen && (
          <>
            <p className="text-gray-600 text-base backdrop-blur-sm">
        ...
        <div className="order-1 sm:order-2 sm:pt- grid justify-center items-center">
          <div className="text-justify sm:text-left lg:px-20">
            ...
            <p className="opacity-50 text-sm lg:mx backdrop-blur-sm">
              We offer seven future-focused specializations — Marketing, Human
              Resources, Finance, Operations, International Business, Business
              Analytics, and Entrepreneurship — complemented by a range of
              globally recognized certifications. Our forward-looking curriculum
              seamlessly integrates technology with business strategy,
              empowering you to thrive in an ever-evolving digital landscape.
              With immersive learning in the dynamic visualisations through
              Power BI, advanced data analysis using Python and R, and
              experiential learning in metaverse you’ll graduate with the
              cutting-edge skills and innovative mindset needed to lead in a
              data-driven world.
            </p>
          </div>
        </div>
