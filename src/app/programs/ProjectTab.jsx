    ...
    <div className="max-w-full mx-auto my-8 bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        <AccordionItem title="Summer Internship Project (SIP)" icon={Calendar}>
          <p className="mb-4">
            The Summer Internship Project provides an opportunity to apply
            tools, techniques, skills, and concepts learned through field
            studies, computer-based analysis, and library research.
          </p>
        ...
        <AccordionItem
          title="Industry Oriented Project (IOP)"
          icon={GraduationCap}
        >
          <p className="mb-4">
            The Industry Oriented Project, conducted in the final semester,
            provides students an opportunity to learn in a real-world context,
            integrating learning across different verticals.
          </p>
          <ul className="list-disc pl-5 space-y-2">
