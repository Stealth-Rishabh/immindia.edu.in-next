...
const pgdm = "/assets/pdfs/BBA Brochure 2025-2028.pdf";
...
const BBAProgram = () => {
  ...
  // Set custom colors, and marquee text when component mounts
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden  ">
      ...
      >
        ...
        >
          <img
            src={isMobile ? "/banners/bbaM.webp" : "/banners/bba.webp"}
